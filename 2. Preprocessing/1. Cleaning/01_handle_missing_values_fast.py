...
[WARN]️ MODE: DIRECT UPDATE (Chỉnh sửa luôn trong MongoDB)
[OK] OPTIMIZED: Batch processing, minimal logging
...
def handle_missing_values_batch_update(db, collection_name):
    ...
    logger.info(f"[CHART] Total documents in collection: {total_docs}\n")
    ...
    logger.info(f"\n[OK] Processing complete! Found {len(update_operations)} documents to update")
