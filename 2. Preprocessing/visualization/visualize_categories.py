...
def get_articles_by_category_group():
    ...
    try:
        ...
        client.close()
        return category_stats, total_articles
        
    except Exception as e:
        print(f"[FAIL] Lỗi kết nối MongoDB: {e}")
        return None

def visualize_categories(category_stats, total_articles):
    ...
    # Thêm thông tin tổng cộng (tính động từ database)
    total_text = f'{total}/{total_articles} bài báo'
...
def main():
    print("=" * 50)
    print("[CHART] BIỂU ĐỒ BÀI BÁO THEO DANH MỤC")
    print("=" * 50)
    print()
    
    # Lấy dữ liệu từ MongoDB
    category_stats, total_articles = get_articles_by_category_group()
    
    if category_stats:
        # Vẽ biểu đồ
        print()
        visualize_categories(category_stats, total_articles)
        print("\n[OK] Hoàn tất!")
    else:
        print("\n[FAIL] Không thể lấy dữ liệu từ MongoDB")
