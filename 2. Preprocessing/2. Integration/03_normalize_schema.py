...
for json_file in sorted(json_files):
    ...
    print(f"  [OK] DateTime changes: {date_changes}/{len(samples)} ({date_changes/len(samples)*100:.1f}%)")
    print(f"  [OK] Category changes: {category_changes}/{len(samples)} ({category_changes/len(samples)*100:.1f}%)")
    print()
...
print("\n" + "=" * 80)
print("[OK] TEST COMPLETE - READY FOR LIVE DATABASE EXECUTION")
print("=" * 80)
