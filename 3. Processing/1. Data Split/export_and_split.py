...
def main():
    try:
        ...
        print("[LAUNCH] Đang kết nối MongoDB (Chế độ Batching chống ngắt mạng)...")
        ...
        print(f"[OK] Đã hốt trọn {len(all_data)} bài báo!")
        ...
        print("-" * 30)
        print("[OK] THÀNH CÔNG RỰC RỠ!")
        print(f"[CHART] Train: {len(train_data)} | Val: {len(val_data)} | Unlabeled: {len(unlabeled)}")
